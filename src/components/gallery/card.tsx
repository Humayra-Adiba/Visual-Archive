...
const Card: FC<IImage> = (props) => {
  ...
  return (
    <figure className="w-full relative group overflow-hidden rounded-md border-[2px] border-slate-700">
      <Image
        alt={name}
        src={url}
        width={400}
        height={400}
        className="w-full object-cover h-[350px] max-w-md group-hover:scale-105 transition-all duration-200"
      />
